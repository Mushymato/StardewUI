...
| [KeyboardSubscriberWithOwner](keyboardsubscriberwithowner.md) | An implementation of IKeyboardSubscriber that forwards keys to the owning [IKeyboardSubscriberOwnerView](ikeyboardsubscriberownerview.md). |
...
| [IKeyboardSubscriberOwnerView](ikeyboardsubscriberownerview.md) | Denotes a view that can be the owner of a [KeyboardSubscriberWithOwner](keyboardsubscriberwithowner.md). |
