...
!!! tip "Framework View"
    ...
    The tag name of this view is `<digits>`.
## Definition
...
| [DigitSprites](#digitsprites)<br/>`digit-sprites` | The sprites for each individual digit, with the index corresponding to the digit itself (element 0 for digit '0', element 4 for digit '4', etc.). This must have exactly 10 elements. | 
...
| [Number](#number)<br/>`number` | The number to display. | 
...
| [Scale](#scale)<br/>`scale` | Scale to draw the digits, relative to their original pixel size. | 
