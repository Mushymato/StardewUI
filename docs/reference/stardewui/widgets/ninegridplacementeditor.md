...
!!! tip "Framework View"
    ...
    The tag name of this view is `<nine-grid-editor>`.
## Definition
...
| [ButtonSpriteMap](#buttonspritemap)<br/>`button-sprite-map` | Map of buttons to button prompt sprites. | 
| [CellColor](#cellcolor)<br/>`cell-color` | The default color to draw grid cells (inside the gridlines). | 
...
| [Content](#content)<br/>`content` | The content to display in the [PositioningOverlay](positioningoverlay.md) when editing. Not shown in the editor itself. | 
...
| [DirectionSpriteMap](#directionspritemap)<br/>`direction-sprite-map` | Map of directions to directional arrow sprites; used to indicate dragging. | 
...
| [GridColor](#gridcolor)<br/>`grid-color` | The color to draw gridlines. | 
...
| [HoverTintColor](#hovertintcolor)<br/>`hover-tint-color` | Color to tint cells and gridlines while the mouse is hovering over the editor. | 
...
| [LineWidth](#linewidth)<br/>`line-width` | Thickness of gridlines. | 
...
| [Placement](#placement)<br/>`placement` | The current content placement. | 
...
| [SelectionBackgroundColor](#selectionbackgroundcolor)<br/>`selection-background-color` | Color for the grid cell that is is selected according to [Placement](ninegridplacementeditor.md#placement). | 
