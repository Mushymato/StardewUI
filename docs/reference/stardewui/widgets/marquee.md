...
!!! tip "Framework View"
    ...
    The tag name of this view is `<marquee>`.
## Definition
...
| [Content](#content)<br/>`content` | Content to scroll inside the marquee. | 
...
| [ExtraDistance](#extradistance)<br/>`extra-distance` | Distance in pixels between the copy of the content being scrolled "out" of the marquee, and the second copy of the content being scrolled "in". | 
...
| [Speed](#speed)<br/>`speed` | Scrolling speed, in pixels per second. | 
