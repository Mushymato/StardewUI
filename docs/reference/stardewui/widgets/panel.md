...
| [HoveredSubject](../view.md#hoveredsubject) | When Lookup Anything (Pathoschild.LookupAnything) is loaded, this Object or NPC is given to lookup anything for it's menu.<br><span class="muted" markdown>(Inherited from [View](../view.md))</span> | 
