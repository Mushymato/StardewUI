...
| [MaxListHeight](#maxlistheight)<br/>`max-list-height` | Maximum height of the expanded list. | 
...
| [OptionFormat](#optionformat)<br/>`option-format` | Specifies how to format the [SelectedOption](dropdownlist-1.md#selectedoption) in the label text. | 
| [OptionMaxLines](#optionmaxlines)<br/>`option-max-lines` | Maximum number of lines to allow per option in the drop-down list. | 
| [OptionMinWidth](#optionminwidth)<br/>`option-min-width` | Minimum width for the text area of an option. | 
| [Options](#options)<br/>`options` | The options available to select. | 
...
| [SelectedIndex](#selectedindex)<br/>`selected-index` | Index of the currently-selected option in the [Options](dropdownlist-1.md#options), or `-1` if none selected. | 
| [SelectedOption](#selectedoption)<br/>`selected-option` | The option that is currently selected, or `null` if there is no selection. | 
| [SelectedOptionText](#selectedoptiontext)<br/>`selected-option-text` | The text of the currently-selected option. | 
| [SelectionFrameLayout](#selectionframelayout)<br/>`selection-frame-layout` | Customizes the layout settings of the selection frame. | 
