...
| [Color](#color)<br/>`color` | The current color. | 
...
| [Presets](#presets)<br/>`presets` | Preset colors to show at the bottom, providing single click convenience for the most common colors. | 
...
| [WheelSprite](#wheelsprite)<br/>`wheel-sprite` | Sprite to display for the Hue-Saturation color wheel. | 
