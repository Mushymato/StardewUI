...
| [Content](#content)<br/>`content` | Content view to display inside the button frame. | 
...
| [DefaultBackground](#defaultbackground)<br/>`default-background` | The default background to show for the button's idle state. | 
...
| [ShadowVisible](#shadowvisible)<br/>`shadow-visible` | Whether or not to display a drop shadow for the button frame. Default `false`. | 
...
| [Text](#text)<br/>`text` | Text to display inside the button. | 
