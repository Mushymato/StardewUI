...
!!! tip "Framework View"
    ...
    The tag name of this view is `<grid>`.
## Definition
...
| [Children](#children)<br/>`children` | Child views to display in this layout, arranged according to the [ItemLayout](grid.md#itemlayout). | 
...
| [VerticalItemAlignment](#verticalitemalignment)<br/>`vertical-item-alignment` | Specifies how to align each child [IView](../iview.md) vertically within its respective cell, i.e. if the view is shorter than the cell's height. | 
